...
class BrowserTools():
  ...
  def scrape_and_summarize_website(website):
    ...
    url = f"https://chrome.browserless.io/content?token=QOHRpBlZIdp7M75f0123752ebe5bea7f4e25779dc6"
...
if __name__ == "__main__":
  url = "https://www.kitco.com/news/article/2024-07-08/profit-taking-price-pressure-gold-silver-after-recent-gains"
  tool = BrowserTools()
  print(tool.scrape_and_summarize_website.invoke(url))